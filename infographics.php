<?php $title = 'Infographics' ; ?>
<?php include($_SERVER['DOCUMENT_ROOT'] . '/head.php') ; ?>

  <div class="right">
    <h3>About this page</h3>
    <p>This is a list of infographics I made about the Marble Hornets web series.  At the moment there are two main infographics- the timeline and the items.  The timeline splits the series into a series of scenes and then lists them in chronological order (or as close as possible, given the ambiguities and synchronised videos in the series), keeping track of the locations and the passages the characters take through the series.  The items keeps track of who has possession of which items throughout the series.</p>
  </div>
